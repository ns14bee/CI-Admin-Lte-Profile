...
class Google_login extends CI_Controller {
 ...
 function login()
 {
  ...
  $google_client->setClientId('914778836678-eppsbknadrp9n43c2v8c9gmnqt8ftvaj.apps.googleusercontent.com'); //Define your ClientID

  $google_client->setClientSecret('3vMvOpiexbOjvcO1liIWFBrm'); //Define your Client Secret Key
